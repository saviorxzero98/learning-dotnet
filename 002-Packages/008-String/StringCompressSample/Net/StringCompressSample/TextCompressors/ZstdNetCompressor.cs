...
{
    public class ZstdNetCompressor : ICompressor
    {
        /// <summary>
        /// 壓縮文字
        /// </summary>
        ...
        public byte[] CompressText(string text)
        {
            ...
            using (var zstdStream = new ZstandardStream(memoryStream, CompressionMode.Compress))
        ...
        public string DecompressText(byte[] bytes)
        {
            ...
            using (var zstdStream = new ZstandardStream(memoryStream, CompressionMode.Decompress))
