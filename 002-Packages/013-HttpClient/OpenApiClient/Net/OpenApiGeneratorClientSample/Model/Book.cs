...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Book : IEquatable<Book>, IValidatableObject
    {
        ...
        public Book(string id = default(string), string name = default(string), int episode = default(int), Author author = default(Author), double price = default(double), DateTime publishDate = default(DateTime), bool isReprint = default(bool))
        {
            this.Id = id;
            this.Name = name;
