...
namespace Org.OpenAPITools.Model
{
    ...
    /// GetBookResult
    /// </summary>
    [DataContract(Name = "GetBookResult")]
    public partial class GetBookResult : IEquatable<GetBookResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBookResult" /> class.
        /// </summary>
        ...
        public GetBookResult(string id = default(string), string name = default(string), int episode = default(int), Author author = default(Author), double price = default(double), DateTime publishDate = default(DateTime), bool isReprint = default(bool))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as GetBookResult);
        }

        /// <summary>
        /// Returns true if GetBookResult instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBookResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBookResult input)
        {
            if (input == null)
            {
                return false;
