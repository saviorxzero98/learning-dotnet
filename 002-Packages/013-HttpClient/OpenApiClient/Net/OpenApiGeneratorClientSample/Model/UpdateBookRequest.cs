...
namespace Org.OpenAPITools.Model
{
    ...
    /// UpdateBookRequest
    /// </summary>
    [DataContract(Name = "UpdateBookRequest")]
    public partial class UpdateBookRequest : IEquatable<UpdateBookRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateBookRequest" /> class.
        /// </summary>
        ...
        public UpdateBookRequest(string id = default(string), string name = default(string), int episode = default(int), Author author = default(Author), double price = default(double), DateTime publishDate = default(DateTime), bool isReprint = default(bool))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateBookRequest);
        }

        /// <summary>
        /// Returns true if UpdateBookRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateBookRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateBookRequest input)
        {
            if (input == null)
            {
                return false;
