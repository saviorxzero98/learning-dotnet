...
using BotGame.GuessNumberGame.Dialogs;
using Microsoft.Bot.Builder;
using Microsoft.Bot.Builder.Dialogs;
using Microsoft.Bot.Schema;

namespace BotGame.GuessNumberGame
{
    public class GuessNumberGameBot : IBot
    {
        private readonly DialogStateAccessors _dialogAccessors;
        private readonly DialogSet _dialogs;

        public GuessNumberGameBot(IBotDataBag botDataBag)
        {
